...
<body>  
<nav class="navbar navbar-expand-lg navbar-light bg-light" style="padding: 0.25rem 0.5rem;">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ml-auto">
            <li class="nav-item active">
                <a class="nav-link" href="#" style="font-size: 0.8rem;">Beranda</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="#" style="font-size: 0.8rem;">Tentang</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="#" style="font-size: 0.8rem;">Kontak</a>
            </li>
        </ul>
    </div>
</nav>
    ...
    <script>
        ...
        function hitungPasangBaru() {
            ...
            // Jika prabayar, tambahkan harga token
            if (jenisPembayaran === 'prabayar') {
            ...
            var penjelasan = "Harga pemasangan baru untuk daya " + daya + " VA adalah Rp " + hargaPasang.toLocaleString('id-ID') + ".";
            if (jenisPembayaran === 'prabayar' && token > 0) {
                penjelasan += "<br>Harga token sebesar Rp " + token.toLocaleString('id-ID') + ".";
            }
            penjelasan += "<br><strong>Total Harga yang harus dibayar:</strong> Rp " + totalHarga.toLocaleString('id-ID') + ".";
        ...
        function hitungPerubahanDaya() {
            ...
            // Tambahkan harga token jika pembayaran prabayar
            if (jenisPembayaran === 'prabayar' && token > 0) {
                tarif += token;
            }
    
            var penjelasan = "Selisih Daya (" + (dayaBaru - dayaLama) + " VA) x Biaya Perubahan Daya";
            penjelasan += (jenisPembayaran === 'prabayar') ? " dengan tambahan harga token." : " tanpa tambahan harga token.";
            if (jenisPembayaran === 'prabayar' && token > 0) {
                penjelasan += "<br>+ Harga token sebesar Rp " + token.toLocaleString('id-ID') + ".";
            }
